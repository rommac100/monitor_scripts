...
xrandr --output eDP-1-1 --off --output DP-1-1 --off --output HDMI-1-1 --mode 1920x1200 --pos 2105x0 --rotate normal --output DP-1-2 --mode 1920x1200 --pos 0x0 --rotate normal --output HDMI-1-2 --off
